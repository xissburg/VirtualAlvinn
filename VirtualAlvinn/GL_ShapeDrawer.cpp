...
public:
	...
	virtual void processTriangle(btVector3* triangle,int partId, int triangleIndex)
	{
		...
		if (m_wireframe)
		{
			glBegin(GL_LINES);
			glColor3f(1, 0, 0);
			glVertex4d(triangle[0].getX(), triangle[0].getY(), triangle[0].getZ(), 1.0);
			glVertex4d(triangle[1].getX(), triangle[1].getY(), triangle[1].getZ(), 1.0);
			glColor3f(0, 1, 0);
			glVertex4d(triangle[2].getX(), triangle[2].getY(), triangle[2].getZ(), 1.0);
			glVertex4d(triangle[1].getX(), triangle[1].getY(), triangle[1].getZ(), 1.0);
			glColor3f(0, 0, 1);
			glVertex4d(triangle[2].getX(), triangle[2].getY(), triangle[2].getZ(), 1.0);
			glVertex4d(triangle[0].getX(), triangle[0].getY(), triangle[0].getZ(), 1.0);
...
//		dz *= halfExtent[2];
	...
	} else
	{
		...
		//If  GL_TEXTURE_2D is not enabled, use default checker texture (if m_textureenabled is true), 
		//otherwise assume that a valid texture map was set prior to this call
